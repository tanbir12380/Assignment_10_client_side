    ...
    >
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        ...
        <SwiperSlide className=' slides slide3'>
          ...
          <p>Switch off lights and appliances when not in use — save energy, save money.</p>
          </div>
        </SwiperSlide>
                <SwiperSlide className='slides slide1'>
          <div>
            <h3>Use the internet wisely</h3>
          <p>Your data is a resource, avoid unnecessary streaming and downloads to reduce digital waste.</p>
          </div>
        </SwiperSlide>
